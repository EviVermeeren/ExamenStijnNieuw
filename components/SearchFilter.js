  ...
  return (
    <View style={styles.extra}>
        <FlatList styles={styles.flat} data={data} renderItem={({item}) => {
                    ...
                    <View style={styles.box}>
                        <TouchableOpacity activeOpacity={0.5}>
                            <View style={styles.listItem}>
                                ...
                                <Pressable style={styles.seeProduct} onPress={() => navigation.navigate("Meer informatie", {itemTitle: item.title.rendered, itemDesc: item.yoast_head_json.og_description})}>
                                    <Text style={styles.text}>Bekijk product: {item.title.rendered}</Text>
                                </Pressable>
            ...
            if(item.yoast_head_json.og_description.toLowerCase().includes(input.toLowerCase())){
              return (
                  <View style={styles.box}>
                      <TouchableOpacity activeOpacity={0.5}>
                          <View style={styles.listItem}>
