    ...
    <View style={styles.screen}>
        ...
        <View style={styles.flex}>
          ...
          <View>
            ...
            <Pressable style={styles.boeton2} onPress={() => {increase();}}>
              <Text style={styles.boetonText}>+</Text>
            </Pressable>

            <Pressable style={styles.boeton2} onPress={() => {decrease();}}>
              <Text style={styles.boetonText}>-</Text>
            </Pressable>
        ...
        <View>
          ...
          <Pressable style={styles.boeton} onPress={() => navigation.navigate("🛒 Winkelkarretje")}>
            <Text style={styles.boetonText2}>Verwijder {route.params.title} uit mandje</Text>
          </Pressable>

          <Pressable style={styles.boeton3} onPress={() => navigation.navigate("Betalen", {purch: route.params.title})}>
            <Text style={styles.boetonText2}>Ik wil {route.params.title} kopen!</Text>
          </Pressable>
        </View>
