  ...
  return (
    <View style={styles.screen}>
        ...
        <View style={styles.flexbox2}>
            ...
            <Pressable onPress={() => navigation.navigate("💵 Winkelkarretje", {uri: route.params.itemUri, desc: route.params.itemDesc, title: route.params.itemTitle})}>
        ...
        <View style={styles.flex}>
            ...
            <View style={styles.flex}>
                ...
                <View>
                    <Pressable style={styles.boeton} onPress={() => {increase();}}>
                    ...
                    <Pressable style={styles.boeton3} onPress={() => navigation.navigate("💵 Winkelkarretje", {uri: route.params.itemUri, desc: route.params.itemDesc, title: route.params.itemTitle})}>
