...
import { Animated, StyleSheet, Text, View, FlatList, Image, Pressable, TouchableOpacity } from 'react-native';
  ...
  return (
    ...
    <View style={styles.screen}>
        ...
        <FadeInView>
          ...
          <LinearGradient colors={['#BDF0FF', '#297287' ]} style={styles.linearGradient2}>
